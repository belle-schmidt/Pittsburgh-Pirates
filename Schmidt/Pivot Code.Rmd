...
Statcast_Combined_Pitches <- Statcast |> 
  mutate(pitch_type = ifelse(pitch_type == "FA", "FF",
         ...
         pfx_x = pfx_x * 12,
         pfx_x = ifelse(pitch_type == "FF" & p_throws == "R", pfx_x * -1, pfx_x)) |> 
...
FanGraphs <- read.csv("C:/Users/isabe/OneDrive/Carnegie Mellon Sports Analytics/Capstone Project/Fangraphs_Pitching_Models_2020-24.csv")
```
